...
$is_author_media_show    = rhr_options( 'is_author_media_show_webinar', '' );
$id = get_the_ID();
$post_profile_id = rhr_get_meta_value( $id, '_rhr_profile_auth_m_w', '' );

if( true == $is_author_media_show ) :
...
?>
    ...
    ?>
        ...
        <?php
            ...
            <a href="<?php esc_url(the_permalink());?>" class="rhr-profile-links"><strong><?php echo esc_html( the_title() ); ?></strong></a> <?php echo html_entity_decode( $bio ); ?>
            </div>
        </div>
