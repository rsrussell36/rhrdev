...
$is_author_media_show_news    = rhr_options( 'is_author_media_show_news', '' );
$id = get_the_ID();
$post_profile_id = rhr_get_meta_value( $id, '_rhr_profile_auth_m_n', '' );

if( true == $is_author_media_show_news ) :
