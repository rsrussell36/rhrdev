        ...
        (i.init = function () {
            ...
            (i.setParallaxMulti = function (t) {
                var n,
                    l = {},
                    o = [];
                if (((l = i.getOptions(t, "rhr_parallax_multi_items")), "multi" == (n = i.getOptions(t, "rhr_section_parallax_multi")))) {
                    if (r) {
            ...
            (i.moveBg = function (e) {
                var t, n;
                t = i.getOptions(e, "rhr_background_parallax"), n = i.getOptions(e, "rhr_background_parallax_speed"), a.addClass("parallax-multi-section"), "yes" != t || r || a.jarallax({
                    speed: n
                })
            }),
            ...
            (i.pushElement = function (e) {
                ...
                var cl = wow_class + wowAnim + "rhr-section-parallax-mousemove rhr-section-parallax-layer elementor-repeater-item-" + e._id;
                0 === a.find(".elementor-repeater-item-" + e._id).length &&
                    "" != e.image.url &&
                    a.prepend(
                        `\n <div data-aos="rotate" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false" data-aos-anchor-placement="top-center" data-wow-delay="${wowDelay}ms" class="${cl} rhr-section-parallax-type-${e.parallax_style}" >\n <img  class="rhr-parallax-graphic ${i}" src="${e.image.url}"/>\n </div>\n                    `
                    );
            }, i.getWOW = function (e) {
                ...
                'yes' == e._mousemove_scroll_enable && void 0 !== e._mousemove_parallax_transform && void 0 !== e._mousemove_parallax_transform_value && a.find(".elementor-repeater-item-" + e._id + ' .rhr-parallax-graphic').magician({
                    type: "scroll",
