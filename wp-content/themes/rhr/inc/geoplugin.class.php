...
*/
	...
	var $regionName = null;
	var $dmaCode = null;
	var $geoplugin_countryCode = null;
	var $countryName = null;
	var $inEU = null;
	var $euVATrate = false;
	var $geoplugin_continentCode = null;
	...
	function locate($ip = null) {
		...
		$this->geoplugin_countryCode = $data['geoplugin_countryCode'];
		$this->countryName = $data['geoplugin_countryName'];
		$this->inEU = $data['geoplugin_inEU'];
		//$this->euVATrate = $data['euVATrate'];
		$this->geoplugin_continentCode = $data['geoplugin_continentCode'];
